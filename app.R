...
Sys.setenv(SPOTIFY_CLIENT_SECRET = Hadi_spotify_client_Secret)
access_token <- get_spotify_access_token()
Sys.setenv(GENIUS_API_TOKEN = Hadi_Genius_client_Access)
library(shiny)
...
ui <- dashboardPage(
    ...
    # Application title
    dashboardHeader(title = "In Love With Music"),
            ...
            tabItem("tracks",
                    ...
                    fluidRow(
                        ...
                        box(
                            ...
                            searchInput(
                                inputId = "track_id_search",
                                label = "Click search icon to update or hit 'Enter'", 
                                placeholder = "Gol Pari",
                                btnSearch = icon("search"), 
                                btnReset = icon("remove"),
                                width = "100%"
                            ),
                    ...
                    fluidRow(
                        box(
                            width = 12, status = "info",
                            title = "Tracks",
                            tableOutput('trak_table_ata'),
                            tableOutput('trak_table_auf'),
                            tableOutput('trak_table_aua')
